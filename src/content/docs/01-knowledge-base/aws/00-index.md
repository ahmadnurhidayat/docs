...
| **10** | [Public-Facing VPC Lattice with Cross-Account Centralized Networking](vpc-lattice-multi-account.md) | Deep dive into internet-facing VPC Lattice architecture across multiple accounts, covering service networks, RAM sharing, resource gateways, DNS, security policies, traffic routing, blue/green deployments, and multi-region failover. |
